...
The idea of a projector housing it has a lens in front to project the light on the road. This ensures nearly all light is focused towards the road. Having a lens means there is a sharp cutoff between illuminated vs non-illuminated region, hence increasing contrast. If you compare this with reflectors, the light in reflectors will blend in more smoothly with the  non-illuminated region.
...
Brightness has nothing to do with color, a yellow bulb can be as bright as a white one.
...
- Even a 30-35W LED, produces same light as a 55W Halogen.
- You can get LED in any color, not just white.
...
- Need a heat sink bolted on to the car to disperse the heat. Heat generation is more than LEDs & Halogens.
- So again similar to LEDs, if your manufacturer hasnt planned for it, doing this after market is really risky.
- Unlike halognes & lEDs, has a startup delay of 1 - 1.5s.

## TLDR: Conclusion.

1. Safety is number one priority. So dont do anything that would blind the person driving towards you!
2. Any after market headlight upgrade is ILLEGAL as per Indian Motor Vehicle Act, in simple terms, if you are caught and you have anything other than stock headlight approved by your manufacturer, you are in trouble.
3. Any after market headlight upgrade will also void your warranty, no matter how much the shop wala convinces you that it wont.
4. Check if you have reflector or projector assembly, if you have a reflector assembly, dont go for LEDs, instead find a better Halogen bulb than the stock one.
5. Color, Brightness & Bulb Type are three different things. You can change each without changing the other two.
6. For projectors, you can upgrade to LED or HID, provided you ensure proper cooling and heat dispersion.
7. Beware of cheap chinese LEDs, they will do more harm then good. Especially during monsoons. Instead spend a bit more for LEDs from well known brands with warranty.
